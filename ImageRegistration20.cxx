...
int main( int argc, char *argv[] )
{
  ...
  DICOMSeries fixedDicomReader( argv[1]);
  DICOMSeries MovingDicomReader( argv[2]);
  
  DICOMSeries *fixedImageReader = &fixedDicomReader;
  DICOMSeries *movingImageReader = &MovingDicomReader;
  
  fixedImageReader->Load();
  movingImageReader->Load();

  registration->SetFixedImage(    fixedImageReader->GetOutput()    );
  registration->SetMovingImage(   movingImageReader->GetOutput()   );
  //fixedImageReader->Update(); //not a member function
